...
export default function Footer() {
  ...
  return (
    <footer className="bg-emerald-50 border-t-2 border-emerald-300 mt-12">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 mb-8">
          ...
          <nav aria-label="Browse categories">
            ...
            <ul className="space-y-2">
              <li><Link href="/search" className="text-slate-700 hover:text-emerald-700 text-sm transition-colors">Search All Pills</Link></li>
              <li><Link href="/color/white" className="text-slate-700 hover:text-emerald-700 text-sm transition-colors">White Pills</Link></li>
              <li><Link href="/shape/round" className="text-slate-700 hover:text-emerald-700 text-sm transition-colors">Round Pills</Link></li>
              <li><Link href="/shape/oval" className="text-slate-700 hover:text-emerald-700 text-sm transition-colors">Oval Pills</Link></li>
            </ul>
          </nav>

          <nav aria-label="Company links">
            <h3 className="text-sm font-semibold text-emerald-900 mb-3">Company</h3>
            <ul className="space-y-2">
              <li><Link href="/about" className="text-slate-700 hover:text-emerald-700 text-sm transition-colors">About</Link></li>
              <li><Link href="/sources" className="text-slate-700 hover:text-emerald-700 text-sm transition-colors">Data Sources</Link></li>
              <li><Link href="/contact" className="text-slate-700 hover:text-emerald-700 text-sm transition-colors">Contact</Link></li>
            </ul>
          </nav>

          <nav aria-label="Legal links">
            <h3 className="text-sm font-semibold text-emerald-900 mb-3">Legal &amp; Safety</h3>
            <ul className="space-y-2">
              <li><Link href="/medical-disclaimer" className="text-slate-700 hover:text-emerald-700 text-sm transition-colors">Medical Disclaimer</Link></li>
              <li><Link href="/privacy" className="text-slate-700 hover:text-emerald-700 text-sm transition-colors">Privacy Policy</Link></li>
              <li><Link href="/terms" className="text-slate-700 hover:text-emerald-700 text-sm transition-colors">Terms of Use</Link></li>
            </ul>
          </nav>

          <nav aria-label="Social media links">
            <h3 className="text-sm font-semibold text-emerald-900 mb-3">Follow Us</h3>
        ...
        <div className="border-t border-emerald-300 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-slate-600 text-xs">© {year} PillSeek. All rights reserved. Data sourced from FDA NDC &amp; DailyMed.</p>
          <p className="text-slate-600 text-xs">Not a medical device. For identification purposes only.</p>
        </div>
      </div>
    </footer>
  )
