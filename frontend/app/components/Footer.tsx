...
export default function Footer({ ivDrugsEnabled = false }: { ivDrugsEnabled?: boolean }) {
  ...
  return (
    <footer className="bg-emerald-50 border-t border-emerald-200 mt-12">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
          ...
          <nav aria-label="Browse categories">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/drugs" className="text-emerald-800 hover:text-emerald-600 text-sm transition-colors">Drugs A–Z</Link></li>
              {ivDrugsEnabled && <li><Link href="/iv" className="text-emerald-800 hover:text-emerald-600 text-sm transition-colors">IV Drugs</Link></li>}
          ...
          <nav aria-label="Company links">
            ...
            <ul className="space-y-2">
              <li><Link href="/about" className="text-emerald-800 hover:text-emerald-600 text-sm transition-colors">About</Link></li>
              <li><Link href="/editorial-team" className="text-emerald-800 hover:text-emerald-600 text-sm transition-colors">Editorial Team</Link></li>
              <li><Link href="/sources" className="text-emerald-800 hover:text-emerald-600 text-sm transition-colors">Data Sources</Link></li>
              <li><Link href="/contact" className="text-emerald-800 hover:text-emerald-600 text-sm transition-colors">Contact</Link></li>
            </ul>
          </nav>
          ...
          <nav aria-label="Legal links">
            ...
            <ul className="space-y-2">
              <li><Link href="/medical-disclaimer" className="text-emerald-800 hover:text-emerald-600 text-sm transition-colors">Medical Disclaimer</Link></li>
              <li><Link href="/privacy" className="text-emerald-800 hover:text-emerald-600 text-sm transition-colors">Privacy Policy</Link></li>
              <li><Link href="/terms" className="text-emerald-800 hover:text-emerald-600 text-sm transition-colors">Terms of Use</Link></li>
            </ul>
          </nav>
        ...
        <div className="border-t border-emerald-200 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
