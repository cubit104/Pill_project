/**
 * Arithmetic behind the infusion rate calculator. No drug data in here on purpose: the nurse types the order
 * and what is in the bag, this only divides and multiplies, and shows how it got there.
 */
