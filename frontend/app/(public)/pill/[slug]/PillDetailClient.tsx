  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
          ...
          return (
            <section aria-label="Share this page" className="bg-white border border-slate-200 rounded-xl shadow-sm px-5 py-3 mb-6 flex items-center gap-3 flex-wrap">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-full border transition-colors border-slate-200 text-slate-600 hover:bg-red-50 hover:border-red-300 hover:text-red-700"
        ...
        {resolvedSlug && pill.has_medguide !== true && pill.has_medication_summary !== true && (
          <section className="grid grid-cols-1 gap-6 md:grid-cols-5 mt-6" data-testid="medication-information-grid">
            <div className="md:col-span-3">
              <section className="bg-white border border-emerald-200 rounded-2xl shadow-sm p-6 h-full">
                <h2 className="text-xl font-semibold text-slate-900 mb-2">
                  Medication Information
                </h2>
                <p className="text-slate-600 mb-4">
