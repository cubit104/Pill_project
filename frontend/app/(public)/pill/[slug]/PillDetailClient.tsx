    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {(() => {
          ...
          return (
            <section aria-label="Share this page" className="bg-white border border-emerald-200 rounded-xl shadow-sm px-5 py-3 mb-6 flex items-center gap-2 flex-nowrap overflow-x-auto">
              <span className="text-xs font-medium text-slate-500 shrink-0">Share:</span>
              <a
                href={twitterUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="shrink-0 flex items-center gap-1.5 text-xs font-medium px-2 py-1 sm:px-3 sm:py-1.5 rounded-full border transition-colors border-slate-200 text-slate-600 hover:bg-sky-50 hover:border-sky-300 hover:text-sky-700"
                aria-label="Share on Twitter"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="w-3.5 h-3.5"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.748l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="shrink-0 flex items-center gap-1.5 text-xs font-medium px-2 py-1 sm:px-3 sm:py-1.5 rounded-full border transition-colors border-slate-200 text-slate-600 hover:bg-blue-50 hover:border-blue-300 hover:text-blue-700"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="shrink-0 flex items-center gap-1.5 text-xs font-medium px-2 py-1 sm:px-3 sm:py-1.5 rounded-full border transition-colors border-slate-200 text-slate-600 hover:bg-red-50 hover:border-red-300 hover:text-red-700"
