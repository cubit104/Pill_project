/**
 * Refill arithmetic. Copy of mobile/src/lib/refill.ts in the app — keep them in
 * sync. The user enters a pill count; the daily rate comes from the reminder
 * schedule unless they typed one. Everything is derived on the client.
 */
