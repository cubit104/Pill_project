...
def test_editorial_team_member_returns_real_schema_fields(client):
    ...
    mock_result.fetchone.return_value = (
        ...
        [{"title": "Registered Physician", "board": "State Medical Board", "url": "https://example-board.gov"}],
    ...
    assert response.json() == {
        ...
        "registrations": [{"title": "Registered Physician", "board": "State Medical Board", "url": "https://example-board.gov"}],
